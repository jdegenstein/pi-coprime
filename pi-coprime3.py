...
inputs = range(num_cores) #set number of parallel OPS to number of threads 


def randomPIE(i):
#i is not used anywhere other than for the parallelization below
    import random
    import math

    # I put these here so you can change them easily
    MAX = 999999999 # highest random number
...
#            a = temp
        ...
        # c is now the GCD of the two random numbers
        if c == 1:
            coprime += 1
        else:
            cofactor += 1
